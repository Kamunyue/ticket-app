...
Route::group(['middleware'=>['auth:sanctum']] , function () {
    ...
    Route::middleware(['bus_operator'])->group(function () {
        ...
        Route::get('/operator/read_routes/{id}', [RouteController::class, 'readRoute']);
        Route::put('/operator/edit_routes/{id}', [RouteController::class, 'editRoute']);

        //bus schedule routes
        Route::post('/operator/input_schedule', [BusScheduleController::class, 'inputBusSchedule']);
        Route::get('/operator/view_schedules', [BusScheduleController::class, 'viewBusSchedule']);
        ...
        //trip routes
        Route::post('/operator/input_trip', [TripController::class, 'makeTrip']);
    });
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::post('/admin/view_schedule', [BusScheduleController::class, 'viewBusSchedule']);
